...
class ConnectionManager extends StateNotifier<ConnectionsState> {
  ...
  void createDirectConnection({required String childBlockId, required String parentBlockId}) {
    ...
    FirestoreService.addConnection(orgId: appState.orgId, assessmentId: appState.assessmentId, connection: newConnection).catchError((error) {
  ...
  void removeConnection(String connectionId) {
    ...
    // Then update Firestore
    FirestoreService.deleteConnection(orgId: appState.orgId, assessmentId: appState.assessmentId, connectionId: connectionId).catchError((error) {
      // If Firestore operation fails, revert UI changes
